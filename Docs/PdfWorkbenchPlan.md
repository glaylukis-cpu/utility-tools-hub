...
**Next: v0.4.0 Step 2 - PDF Workbench UI shell**

- reorganize `PdfToolsPanel` layout into workbench sections
- no new PDF processing
- no preview yet
- preserve Merge / Split / Extract / Rotate / Delete

v0.4.0 Step 2 introduces the PDF Workbench UI shell. It reorganizes the PDF Tools screen for future preview, page list, reorder, overlay writing, and safety guidance. No new PDF processing feature is added in this step.
